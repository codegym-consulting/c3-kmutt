    ...
    <div>
        ...
        <UContainer class="flex justify-center absolute inset-0 h-fit m-auto">
            <UCard data-aos="fade-up" as="article" :ui="{
                ...
                <div class="max-w-[820px] mx-auto text-center w-full flex flex-col items-center gap-y-14">
                    <figure class="hidden md:block">
                        <img src="/logo/logo_full.svg" alt="3c_logo">
                    </figure>
                    <div class="flex flex-col items-center gap-y-6">
                        <UIcon name="prime:thumbs-up" class="w-12 h-12 text-gray-10" />
                        <h1 class="heading-label">Resume successfully created!</h1>
                        <p class="text-gray-10 text-base leading-5">
                            Your resume template has been successfully created. Start showcasing your professional
                            journey!
                        </p>
                    </div>
                    <NuxtLink :to="'/workspace'" class="round-icon-btn w-[72px] h-[72px] [&_svg]:w-8 [&_svg]:h-8">
