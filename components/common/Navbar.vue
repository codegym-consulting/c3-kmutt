...
<template>
  <div>
    <Affix target-name="#page-container" :relative-element="props.relativeElement" :off-set-y="0" :active-class="$classes(
      ...
      <nav>
        ...
        <div class="action-group">
          <UButton class="hidden lg:inline-flex" label="Search" variant="outline" to="/search" />
          <UButton label="Login" />
        </div>
